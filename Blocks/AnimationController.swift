...
class BlocksController: UIViewController {
  ...
  private func createObjects() -> [ScreenObject] {
    let obj1 = ScreenObject(colorStart : UIColor.red, colorEnd : UIColor.green, title : "MOOD", image : UIImage(named : "pic_agony")!, controller : DummyController())
    ...
    let obj5 = ScreenObject(colorStart : UIColor.red, colorEnd : UIColor.green, title : "SCIENCE", image : UIImage(named : "pic_science")!, controller : DummyController())
    ...
    let obj8 = ScreenObject(colorStart : UIColor.red, colorEnd : UIColor.green, title : "DEVELOPMENT", image : UIImage(named : "pic_gaming")!, controller : DummyController())
